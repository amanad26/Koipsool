...
import static com.koipsool_new.kapsoolModels.CommonMethods.isValidEmail;
...
import com.koipsool_new.databinding.ActivityPharmaSignupBinding;
...
public class PharmaSignupActivity extends AppCompatActivity {

   private ActivityPharmaSignupBinding binding ;
   private PharmaSignupActivity activity ;
   ...
   private  String fcmId = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPharmaSignupBinding.inflate(getLayoutInflater());
        ...
        binding.gotologin.setOnClickListener(view -> {
            Intent intent = new Intent(PharmaSignupActivity.this, PharmaLoginActivity.class);
                ...
                try {
                    ...
                    if(response.code() == 200)
                        if(response.body() != null && response.body().getResult().equalsIgnoreCase("true")){
                            ...
                            Intent intent = new Intent(PharmaSignupActivity.this, OtpVerificationActivity.class);
                            startActivity(intent);
    ...
    private boolean validate(){
        if(binding.email.getText().toString().equalsIgnoreCase("")){
         ...
         else if(binding.companyname.getText().toString().equalsIgnoreCase("")){
            binding.companyname.setError("Enter Your Company Name...!");
