...
import com.koipsool_new.databinding.ActivityClientsBillBinding;
...
public class ClientsBillActivity extends AppCompatActivity {

    private ClientsBillActivity activity;
    private Session session;
    private ActivityClientsBillBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityClientsBillBinding.inflate(getLayoutInflater());
