...
public class CompanyProfileModel {
    ...
    @SerializedName("data")
    @Expose
    private List<CompanyProfileData> data;
    ...
    public List<CompanyProfileData> getData() {
        return data;
    }

    public void setData(List<CompanyProfileData> data) {
        this.data = data;
    }
    ...
    public class CompanyProfileData {
        ...
        public String toString() {
            return "CompanyProfileData{" +
                    ...
                    ", drugsLicenceImage='" + drugsLicenceImage + '\'' +
                    ", gstNo='" + gstNo + '\'' +
                    ", fcmId='" + fcmId + '\'' +
                    ", ceilingIn='" + ceilingIn + '\'' +
                    ", stateName='" + stateName + '\'' +
